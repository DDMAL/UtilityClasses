...
public class AudioSamples
{
	 ...
	 /**
      * The AudioFileFormat of the audio file from which samples were originally
	  * parsed. Will be null if not available.
      */
	 protected AudioFileFormat			original_audio_file_format;
          ...
          throws Exception
     {
		  ...
		  original_audio_file_format = AudioSystem.getAudioFileFormat(audio_file);
          ...
          throws Exception
     {
		  ...
		  original_audio_file_format = null;
	 ...
	 /**
	  * Returns the AudioFileFormat of the file from which the samples
	  * were originally parsed.
	  * 
	  * @return	The AudioFileFormat of the file from which the samples
	  *			were originally parsed. Null if this information is not
	  *			available.
	  */
	 public AudioFileFormat getOriginalAudioFileFormat()
	 {
		 return original_audio_file_format;
	 }
     ...
     /**
      * Returns the stored audio samples between the given times in seconds.
      *
      * @param	start_time    The time, in seconds, of the first sample to
      *                       return. Must be 0 or higher and must be less than
      *                       end_time.
