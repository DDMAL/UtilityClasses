...
public class StringMethods
{
	...
	public static String wrapString(String to_wrap, int chars_per_line, int hanging_indent)
	{
	  ...
	  * in the given duration, followed by a key.
	  * 
	 ...
	 public static String getFormattedDuration(long duration)
	 {
		 ...
		 long milliseconds = duration - TimeUnit.SECONDS.toMillis(seconds);
		 
		 String f_minutes = String.format("%02d", minutes);
		 String f_seconds = String.format("%02d", seconds);
		 String f_milliseconds = String.format("%03d", milliseconds);
		 
		 return hours + ":" + f_minutes + ":" + f_seconds + ":" + f_milliseconds + " (hours:mins:secs:ms)";
	 }
